...
$csv_hdr=" , , , , Time Duration [In Hours]\nTicket, Priority, Default User, TE Team, Product Management, Engineering, Client Ops, Miscellaneous, Total";
                                                    ...
                                                    $input = str_replace(" ", "", "<br/>" . $input); //REMOVES <SPACE>
						    $input_ticket=  str_replace("<br/>"," ",$input);
                                                    $Ticket = explode(",", $input); //CREATES AN ARRAY FROM STRING when finds COMMA
                                                    $Ticket[0] = str_replace("<br/>", "", $Ticket[0]); //REMOVES <br/>
					...
					//TEAM ARRAY DECLARATION ENDS
                                ...
                                echo  '
                                    ...
                                    <tr><td><br/><br/><input type="submit" value="Try Again" name="Submit" class="pure-button pure-button-primary"/></td></tr>
                                    </table>
                                    </form>
				    ...
				    <p>Time tracker is having trouble accessing the Ticket(s). This is usually caused if the Ticket you have entered cannot be found.</p><p>You can try : </p><p>
					<ul>
...
<?echo $username.' used JIRA TIME tracker and analysed following Tickets :  %0A%0A'.$input_ticket.'%0A%0ANumber of Tickets Analysed : '.$total_tickets_analysed ?>"><button class="pure-button pure-button-primary">Submit Feedback</button></a></tr></table></div>
    </div>
